...
public class ItemMapperImplTest {
    ...
    @Test
    public void shouldReturnNullWhenMapperFromNullItemDto() {
    ...
    @Test
    public void shouldReturnItemDtoFromMapper() {
    ...
    @Test
    public void shouldReturnNullWhenMapperFromNullItem() {
    ...
    @Test
    public void shouldReturnNullWhenMapperFromNullItemExtendedDto() {
    ...
    @Test
    public void shouldReturnNullWhenMapperFromNull() {
    ...
    @Test
    public void shouldReturnNullWhenMapperFromNullComment() {
